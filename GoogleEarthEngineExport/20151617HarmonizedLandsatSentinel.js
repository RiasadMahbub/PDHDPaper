var PDHD2015 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2015"),
    ...
    PDHD2017 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2017"),
...
var processedPOI1_2015 = processedPOI1.filterDate('2015-01-01', '2015-12-31');
var processedPOI1_2016 = processedPOI1.filterDate('2016-01-01', '2016-12-31');
var processedPOI1_2017 = processedPOI1.filterDate('2017-01-01', '2017-12-31');

var processedPOI2_2015 = processedPOI2.filterDate('2015-01-01', '2015-12-31');
var processedPOI2_2016 = processedPOI2.filterDate('2016-01-01', '2016-12-31');
var processedPOI2_2017 = processedPOI2.filterDate('2017-01-01', '2017-12-31');

var processedPOI3_2015 = processedPOI3.filterDate('2015-01-01', '2015-12-31');
var processedPOI3_2016 = processedPOI3.filterDate('2016-01-01', '2016-12-31');
var processedPOI3_2017 = processedPOI3.filterDate('2017-01-01', '2017-12-31');

var processedPOI4_2015 = processedPOI4.filterDate('2015-01-01', '2015-12-31');
var processedPOI4_2016 = processedPOI4.filterDate('2016-01-01', '2016-12-31');
var processedPOI4_2017 = processedPOI4.filterDate('2017-01-01', '2017-12-31');

var processedPOI5_2015 = processedPOI5.filterDate('2015-01-01', '2015-12-31');
var processedPOI5_2016 = processedPOI5.filterDate('2016-01-01', '2016-12-31');
var processedPOI5_2017 = processedPOI5.filterDate('2017-01-01', '2017-12-31');

var processedPOI6_2015 = processedPOI6.filterDate('2015-01-01', '2015-12-31');
var processedPOI6_2016 = processedPOI6.filterDate('2016-01-01', '2016-12-31');
var processedPOI6_2017 = processedPOI6.filterDate('2017-01-01', '2017-12-31');
