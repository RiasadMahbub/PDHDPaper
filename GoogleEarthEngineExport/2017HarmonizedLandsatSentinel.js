var PDHD2017 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2017"),
...
//   return image.clipToCollection(PDHD2017);
// };
...
var processedPOI1 = processedPOI1.filterDate('2017-01-01', '2017-12-31');
var processedPOI2 = processedPOI2.filterDate('2017-01-01', '2017-12-31');
var processedPOI3 = processedPOI3.filterDate('2017-01-01', '2017-12-31');
var processedPOI4 = processedPOI4.filterDate('2017-01-01', '2017-12-31');
var processedPOI5 = processedPOI5.filterDate('2017-01-01', '2017-12-31');
var processedPOI6 = processedPOI6.filterDate('2017-01-01', '2017-12-31');

// Extract and print the FIELD_NAME values
var fieldNames = PDHD2017.aggregate_array('FIELD_NAME');

// ######################################################################################################
//                              ### AUTOMATED VI EXPORT BY PATHROWTIL ###
// ######################################################################################################
/// Load the PDHD2017 FeatureCollection
var PDHD2017 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2017');
print("PDHD2017",PDHD2017)
var F_8262_13_Sm_1 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8262_13_Sm_1'));
var F_8263_14_Sm_2 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8263_14_Sm_2'));
var F_8259_3_M3 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8259_3_M3'));
var F_8254_4_M10 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8254_4_M10'));
var F_8245_23_Cr = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8245_23_Cr'));
var F_8266_33_AP_1 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8266_33_AP_1'));
var F_8290_27_Pn_1 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8290_27_Pn_1'));
var F_8292_29_Pn_3 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8292_29_Pn_3'));
var F_8291_28_Pn_2 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8291_28_Pn_2'));
var F_8309_55_3 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8309_55_3'));
var F_8307_53_1 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8307_53_1'));
var F_8308_54_2 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8308_54_2'));
var F_8320_66_6 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8320_66_6'));
var F_8319_65_5 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_8319_65_5'));
var F_20581_68_MF = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_20581_68_MF'));
var F_20580_67_58_Acre = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_20580_67_58_Acre'));
var F_403 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_403'));
var F_404 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'F_404'));
var Judys = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var East_Harvey = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var West_Harvey = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'West_Harvey'));
var Flat = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Flat'));
var Pops = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Seed_Rice = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Seed_Rice'));
var Shanes = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Haley = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var Morris = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Morris'));
var Carr_North = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Carr_North'));
var Carr_South = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Carr_South'));
var West_Joe_T = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'West_Joe_T'));
var The_90 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var Hole_40 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Hole_40'));
var Frog_40 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Frog_40'));
var Mid_40_Hwy = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Mid_40_Hwy'));
var Wst_Shop_40 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Shop_40'));
var HQ_Shop = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Way_01 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var New_Ground = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_03 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_06 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Bransford_Est = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_10 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Cattlet_02 = PDHD2017.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_02'));
...
var results = {
  ...
  'F_403': reduceByFeatureCollection(processedPOI2, F_403),
  'F_404': reduceByFeatureCollection(processedPOI2, F_404),
...
var meteoResults = {
  ...
  'F_403': reduceByFeatureCollection(mergedCollection, F_403),
  'F_404': reduceByFeatureCollection(mergedCollection, F_404),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2017', // Updated filename
