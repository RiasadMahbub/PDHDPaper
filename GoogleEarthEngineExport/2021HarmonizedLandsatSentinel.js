var PDHD2021 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2021"),
...
// ######################################################################################################
/// Load the PDHD2021 FeatureCollection
var PDHD2021 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2021');
print("PDHD2021",PDHD2021)
var F_8248_10_M6 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8245_23_Cr = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8245_23_Cr'));
var F_8290_27_Pn_1 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8290_27_Pn_1'));
var F_8292_29_Pn_3 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8292_29_Pn_3'));
var F_8291_28_Pn_2 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8291_28_Pn_2'));
var F_8313_59_7 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8313_59_7'));
var F_8310_56_4 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_8310_56_4'));
var F_20578_65_Wg_N = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_20578_65_Wg_N'));
var MT1 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'MT1'));
var MT3 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'MT3'));
var Clark13 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Clark13'));
var Clark14 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Clark14'));
var Judys = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var Pops = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Haley = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var The_90 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var Lyntz = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Way_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var New_Ground = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Kelly_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_03 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_08 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Bransford_Est = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_09 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_09'));
var East_10 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Cattlet_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_02'));
var Walls_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_01'));
var Walls_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_02'));
var Walls_03 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_03'));
var Walls_04 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_04'));
var Walls_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_05'));
var Walls_09 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_09'));
var Walls_10 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_10'));
var Walls_11 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_11'));
var Walls_12 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_12'));
var Walls_13 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'Walls_13'));
var S01_Farm_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'S01_Farm_01'));
var S03_Farm_01 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'S03_Farm_01'));
var R10W_Farm_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'R10W_Farm_02'));
var RS_5W_Farm_02 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'RS_5W_Farm_02'));
var K164_Farm_03 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'K164_Farm_03'));
var T19M_Farm_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'T19M_Farm_05'));
var N4_Farm_05 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'N4_Farm_05'));
var F_6E_Farm_8 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_6E_Farm_8'));
var F_1_Farm_8 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'F_1_Farm_8'));
var South_0_Farm_09 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'South_0_Farm_09'));
var North_0_Farm_09 = PDHD2021.filter(ee.Filter.eq('FIELD_NAME', 'North_0_Farm_09'));
...
var results = {
  ...
  'MT1': reduceByFeatureCollection(processedPOI4, MT1),
  'MT3': reduceByFeatureCollection(processedPOI4, MT3),
  'Clark13': reduceByFeatureCollection(processedPOI6, Clark13),
  'Clark14': reduceByFeatureCollection(processedPOI6, Clark14),
  ...
  'S01_Farm_01': reduceByFeatureCollection(processedPOI1, S01_Farm_01),
  'S03_Farm_01': reduceByFeatureCollection(processedPOI1, S03_Farm_01),
  'R10W_Farm_02': reduceByFeatureCollection(processedPOI1, R10W_Farm_02),
  'RS_5W_Farm_02': reduceByFeatureCollection(processedPOI1, RS_5W_Farm_02),
  'K164_Farm_03': reduceByFeatureCollection(processedPOI1, K164_Farm_03),
  'K164_Farm_03': reduceByFeatureCollection(processedPOI1, K164_Farm_03),
  'T19M_Farm_05': reduceByFeatureCollection(processedPOI1, T19M_Farm_05),
  'N4_Farm_05': reduceByFeatureCollection(processedPOI1, N4_Farm_05),
  'F_6E_Farm_8': reduceByFeatureCollection(processedPOI1, F_6E_Farm_8),
  'F_1_Farm_8': reduceByFeatureCollection(processedPOI1, F_1_Farm_8),
...
var meteoResults = {
  ...
  'MT1': reduceByFeatureCollection(mergedCollection, MT1),
  'MT3': reduceByFeatureCollection(mergedCollection, MT3),
  'Clark13': reduceByFeatureCollection(mergedCollection, Clark13),
  'Clark14': reduceByFeatureCollection(mergedCollection, Clark14),
  ...
  'S01_Farm_01': reduceByFeatureCollection(mergedCollection, S01_Farm_01),
  'S03_Farm_01': reduceByFeatureCollection(mergedCollection, S03_Farm_01),
  'R10W_Farm_02': reduceByFeatureCollection(mergedCollection, R10W_Farm_02),
  'RS_5W_Farm_02': reduceByFeatureCollection(mergedCollection, RS_5W_Farm_02),
  'K164_Farm_03': reduceByFeatureCollection(mergedCollection, K164_Farm_03),
  'K164_Farm_03': reduceByFeatureCollection(mergedCollection, K164_Farm_03),
  'T19M_Farm_05': reduceByFeatureCollection(mergedCollection, T19M_Farm_05),
  'N4_Farm_05': reduceByFeatureCollection(mergedCollection, N4_Farm_05),
  'F_6E_Farm_8': reduceByFeatureCollection(mergedCollection, F_6E_Farm_8),
  'F_1_Farm_8': reduceByFeatureCollection(mergedCollection, F_1_Farm_8),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2021', // Updated filename
