var PoI = /* color: #d63000 */ee.Geometry.Point([-91.75204840929585, 34.58717879743646]),
    PDHD2016 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2016"),
    table = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2016");
...
print('Last image year:', ee.Date(sorted.sort('system:time_start', false).first().get('system:time_start')).get('year'));
...
//   return image.clipToCollection(PDHD2016);
// };
...
var processedPOI1 = processedPOI1.filterDate('2016-01-01', '2016-12-31');
var processedPOI2 = processedPOI2.filterDate('2016-01-01', '2016-12-31');
var processedPOI3 = processedPOI3.filterDate('2016-01-01', '2016-12-31');
var processedPOI4 = processedPOI4.filterDate('2016-01-01', '2016-12-31');
var processedPOI5 = processedPOI5.filterDate('2016-01-01', '2016-12-31');
var processedPOI6 = processedPOI6.filterDate('2016-01-01', '2016-12-31');

// Extract and print the FIELD_NAME values
var fieldNames = PDHD2016.aggregate_array('FIELD_NAME');

// ######################################################################################################
//                              ### AUTOMATED VI EXPORT BY PATHROWTIL ###
// ######################################################################################################
/// Load the PDHD2016 FeatureCollection
var PDHD2016 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2016');
print("PDHD2016",PDHD2016)
var F_8262_13_Sm_1 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8262_13_Sm_1'));
var F_8261_9_M7 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8261_9_M7'));
var F_8263_14_Sm_2 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8263_14_Sm_2'));
var F_8248_10_M6 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8253_37_KD_Shack = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8253_37_KD_Shack'));
var F_8250_12_M8 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8250_12_M8'));
var F_8249_39_BD_E = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8249_39_BD_E'));
var F_8245_23_Cr = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8245_23_Cr'));
var F_8268_30_BS = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8268_30_BS'));
var F_8266_33_AP_1 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8266_33_AP_1'));
var F_8274_20_M14 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8274_20_M14'));
var F_8294_35_Ryan_E = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8294_35_Ryan_E'));
var F_8289_22_MP = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8289_22_MP'));
var F_8290_27_Pn_1 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8290_27_Pn_1'));
var F_8292_29_Pn_3 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8292_29_Pn_3'));
var F_8291_28_Pn_2 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8291_28_Pn_2'));
var F_8309_55_3 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8309_55_3'));
var F_8310_56_4 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8310_56_4'));
var F_8307_53_1 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8307_53_1'));
var F_8308_54_2 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'F_8308_54_2'));
var Judys = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var East_Harvey = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var West_Harvey = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'West_Harvey'));
var Flat = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Flat'));
var Pops = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Seed_Rice = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Seed_Rice'));
var Shanes = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Haley = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var Morris = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Morris'));
var Carr_North = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Carr_North'));
var Carr_South = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Carr_South'));
var West_Joe_T = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'West_Joe_T'));
var The_90 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var Hole_40 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Hole_40'));
var Frog_40 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Frog_40'));
var Mid_40_Hwy = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Mid_40_Hwy'));
var Wst_Shop_40 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Shop_40'));
var HQ_Shop = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Experiment = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Experiment'));
var Way_01 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var New_Ground = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_03 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_06 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Bransford_Est = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_03 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_03'));
var East_04 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_09 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_09'));
var East_10 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Cattlet_02 = PDHD2016.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_02'));
...
var results = {
  ...
  'F_8253_37_KD_Shack': reduceByFeatureCollection(processedPOI1, F_8253_37_KD_Shack),
  ...
  'F_8274_20_M14': reduceByFeatureCollection(processedPOI1, F_8274_20_M14),
  'F_8294_35_Ryan_E': reduceByFeatureCollection(processedPOI1, F_8294_35_Ryan_E),
  ...
  'Experiment': reduceByFeatureCollection(processedPOI1, Experiment),
...
var meteoResults = {
  ...
  'F_8253_37_KD_Shack': reduceByFeatureCollection(mergedCollection, F_8253_37_KD_Shack),
  ...
  'F_8274_20_M14': reduceByFeatureCollection(mergedCollection, F_8274_20_M14),
  'F_8294_35_Ryan_E': reduceByFeatureCollection(mergedCollection, F_8294_35_Ryan_E),
  ...
  'Experiment': reduceByFeatureCollection(mergedCollection, Experiment),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2016', // Updated filename
