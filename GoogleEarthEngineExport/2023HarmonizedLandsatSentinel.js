var PDHD2023 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2023"),
...
// ######################################################################################################
/// Load the PDHD2023 FeatureCollection
var PDHD2023 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2023');
print("PDHD2023",PDHD2023)
var F_8248_10_M6 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8245_23_Cr = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'F_8245_23_Cr'));
var F_8290_27_Pn_1 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'F_8290_27_Pn_1'));
var F_8292_29_Pn_3 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'F_8292_29_Pn_3'));
var F_20578_65_Wg_N = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'F_20578_65_Wg_N'));
var Greenfield_NW19 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Greenfield_NW19'));
var Clark14 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Clark14'));
var Clark13 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Clark13'));
var East_Harvey = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var Flat = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Flat'));
var Pops = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Shanes = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Carr_North = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Carr_North'));
var Carr_South = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Carr_South'));
var West_Joe_T = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'West_Joe_T'));
var The_90 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var HQ_Shop = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Way_01 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var New_Ground = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_03 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_06 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Mid_Bransford = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_02 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_09 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_09'));
var East_10 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Walls_01 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_01'));
var Walls_02 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_02'));
var Walls_03 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_03'));
var Walls_04 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_04'));
var Walls_05 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_05'));
var Walls_09 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_09'));
var Walls_11 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_11'));
var Walls_12 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_12'));
var Walls_13 = PDHD2023.filter(ee.Filter.eq('FIELD_NAME', 'Walls_13'));
...
var results = {
  ...
  'Greenfield_NW19': reduceByFeatureCollection(processedPOI6, Greenfield_NW19),
...
var meteoResults = {
  ...
  'Greenfield_NW19': reduceByFeatureCollection(mergedCollection, Greenfield_NW19),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2023', // Updated filename
