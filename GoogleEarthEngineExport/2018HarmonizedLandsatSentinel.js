...
var S2_15SXU = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
...
var S2_16SBE = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '16SBE'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);

// Filter Sentinel-2 for 15SWV
var S2_15SWV = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SWV'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);

// Filter Sentinel-2 for 15SYV
var S2_15SYV = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SYV'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);

// Filter Sentinel-2 for 15SWU
var S2_15SWU = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SWU'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);

// Filter Sentinel-2 for 15SXV
var S2_15SXV = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
...
var S2_col1_PoI1 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SXU'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
var S2_col1_PoI2 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '16SBE'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
var S2_col1_PoI3 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SWV'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
var S2_col1_PoI4 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SYV'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
var S2_col1_PoI5 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SWU'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
var S2_col1_PoI6 = ee.ImageCollection("COPERNICUS/S2_SR_HARMONIZED")
  .filter(ee.Filter.eq('MGRS_TILE', '15SXV'))
  .filter(ee.Filter.lt('CLOUDY_PIXEL_PERCENTAGE', maxCloudCoverSentinel))
  .filterDate(startDate, endDate);
...
// print("S2_NDVI_PoI4", S2_NDVI2_PoI4);
// print("S2_NDVI_PoI5", S2_NDVI2_PoI5);
// print("S2_NDVI_PoI1", S2_NDVI2_PoI1);
// print("S2_NDVI_PoI6", S2_NDVI2_PoI6);
// print("S2_NDVI_PoI3", S2_NDVI2_PoI3);
// print("S2_NDVI_PoI2", S2_NDVI2_PoI2);
...
var processedPOI1 = processedPOI1.filterDate('2018-01-01', '2018-12-31');
var processedPOI2 = processedPOI2.filterDate('2018-01-01', '2018-12-31');
var processedPOI3 = processedPOI3.filterDate('2018-01-01', '2018-12-31');
var processedPOI4 = processedPOI4.filterDate('2018-01-01', '2018-12-31');
var processedPOI5 = processedPOI5.filterDate('2018-01-01', '2018-12-31');
var processedPOI6 = processedPOI6.filterDate('2018-01-01', '2018-12-31');

// Extract and print the FIELD_NAME values
var fieldNames = table.aggregate_array('FIELD_NAME');

// ######################################################################################################
//                              ### AUTOMATED VI EXPORT BY PATHROWTIL ###
// ######################################################################################################
/// Load the PDHD2018 FeatureCollection
var PDHD2018 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2018');
print("PDHD2018",PDHD2018)
var F_8261_9_M7 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8261_9_M7'));
var F_8263_14_Sm_2 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8263_14_Sm_2'));
var F_8248_10_M6 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8250_12_M8 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8250_12_M8'));
var F_8249_39_BD_E = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8249_39_BD_E'));
var F_8266_33_AP_1 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8266_33_AP_1'));
var F_8309_55_3 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8309_55_3'));
var F_8310_56_4 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8310_56_4'));
var F_8320_66_6 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8320_66_6'));
var F_8318_64_4 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8318_64_4'));
var F_8319_65_5 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_8319_65_5'));
var F_20581_68_MF = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20581_68_MF'));
var F_20578_65_Wg_N = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20578_65_Wg_N'));
var F_20579_66_Wg_S = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20579_66_Wg_S'));
var F_20580_67_58_Acre = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20580_67_58_Acre'));
var F_20582_69_Res_N = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20582_69_Res_N'));
var F_20583_70_Res_S = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_20583_70_Res_S'));
var F_201 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_201'));
var F_202 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'F_202'));
var Way_01 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Judys = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var East_Harvey = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var Pops = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Seed_Rice = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Seed_Rice'));
var Shanes = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Haley = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var Morris = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Morris'));
var The_90 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var Hole_40 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Hole_40'));
var Frog_40 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Frog_40'));
var Mid_40_Hwy = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Mid_40_Hwy'));
var Wst_Shop_40 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Shop_40'));
var HQ_Shop = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Way_02 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var New_Ground = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_03 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_06 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Bransford_Est = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_10 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Cattlet_02 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_02'));
var LOB_Farm_01 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'LOB_Farm_01'));
var R10E_Farm_02 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'R10E_Farm_02'));
var H110_Farm_3 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'H110_Farm_3'));
var B5_Farm_5 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'B5_Farm_5'));
var Town_Square_Farm_06 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Town_Square_Farm_06'));
var Field_2_Farm_8 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'Field_2_Farm_8'));
var South_0_Farm_09 = PDHD2018.filter(ee.Filter.eq('FIELD_NAME', 'South_0_Farm_09'));
...
var results = {
  'F_8261_9_M7': reduceByFeatureCollection(processedPOI1, F_8261_9_M7),
  'F_8263_14_Sm_2': reduceByFeatureCollection(processedPOI1, F_8263_14_Sm_2),
  'F_8248_10_M6': reduceByFeatureCollection(processedPOI1, F_8248_10_M6),
  'F_8250_12_M8': reduceByFeatureCollection(processedPOI1, F_8250_12_M8),
  'F_8249_39_BD_E': reduceByFeatureCollection(processedPOI1, F_8249_39_BD_E),
  'F_8266_33_AP_1': reduceByFeatureCollection(processedPOI1, F_8266_33_AP_1),
  'F_8309_55_3': reduceByFeatureCollection(processedPOI1, F_8309_55_3),
  'F_8310_56_4': reduceByFeatureCollection(processedPOI1, F_8310_56_4),
  ...
  'F_20578_65_Wg_N': reduceByFeatureCollection(processedPOI1, F_20578_65_Wg_N),
  'F_20579_66_Wg_S': reduceByFeatureCollection(processedPOI1, F_20579_66_Wg_S),
  'F_20580_67_58_Acre': reduceByFeatureCollection(processedPOI1, F_20580_67_58_Acre),
  ...
  'F_201': reduceByFeatureCollection(processedPOI2, F_201),
  'F_202': reduceByFeatureCollection(processedPOI2, F_202),
  ...
  'LOB_Farm_01': reduceByFeatureCollection(processedPOI1, LOB_Farm_01),
  'R10E_Farm_02': reduceByFeatureCollection(processedPOI1, R10E_Farm_02),
  'H110_Farm_3': reduceByFeatureCollection(processedPOI1, H110_Farm_3),
  'B5_Farm_5': reduceByFeatureCollection(processedPOI1, B5_Farm_5),
  'Town_Square_Farm_06': reduceByFeatureCollection(processedPOI3, Town_Square_Farm_06),
  'Field_2_Farm_8': reduceByFeatureCollection(processedPOI1, Field_2_Farm_8),
  'South_0_Farm_09': reduceByFeatureCollection(processedPOI1, South_0_Farm_09)
};
...
print("mergedCollectionmeteo", mergedCollection);
...
var meteoResults = {
  'F_8261_9_M7': reduceByFeatureCollection(mergedCollection, F_8261_9_M7),
  'F_8263_14_Sm_2': reduceByFeatureCollection(mergedCollection, F_8263_14_Sm_2),
  'F_8248_10_M6': reduceByFeatureCollection(mergedCollection, F_8248_10_M6),
  'F_8250_12_M8': reduceByFeatureCollection(mergedCollection, F_8250_12_M8),
  'F_8249_39_BD_E': reduceByFeatureCollection(mergedCollection, F_8249_39_BD_E),
  'F_8266_33_AP_1': reduceByFeatureCollection(mergedCollection, F_8266_33_AP_1),
  'F_8309_55_3': reduceByFeatureCollection(mergedCollection, F_8309_55_3),
  'F_8310_56_4': reduceByFeatureCollection(mergedCollection, F_8310_56_4),
  ...
  'F_20578_65_Wg_N': reduceByFeatureCollection(mergedCollection, F_20578_65_Wg_N),
  'F_20579_66_Wg_S': reduceByFeatureCollection(mergedCollection, F_20579_66_Wg_S),
  'F_20580_67_58_Acre': reduceByFeatureCollection(mergedCollection, F_20580_67_58_Acre),
  ...
  'F_201': reduceByFeatureCollection(mergedCollection, F_201),
  'F_202': reduceByFeatureCollection(mergedCollection, F_202),
  ...
  'LOB_Farm_01': reduceByFeatureCollection(mergedCollection, LOB_Farm_01),
  'R10E_Farm_02': reduceByFeatureCollection(mergedCollection, R10E_Farm_02),
  'H110_Farm_3': reduceByFeatureCollection(mergedCollection, H110_Farm_3),
  'B5_Farm_5': reduceByFeatureCollection(mergedCollection, B5_Farm_5),
  'Town_Square_Farm_06': reduceByFeatureCollection(mergedCollection, Town_Square_Farm_06),
  'Field_2_Farm_8': reduceByFeatureCollection(mergedCollection, Field_2_Farm_8),
  'South_0_Farm_09': reduceByFeatureCollection(mergedCollection, South_0_Farm_09)
};
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2018', // Updated filename
