var PDHD2022 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2022"),
...
// ######################################################################################################
/// Load the PDHD2022 FeatureCollection
var PDHD2022 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2022');
print("PDHD2022",PDHD2022)
var F_8248_10_M6 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8259_3_M3 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_8259_3_M3'));
var F_8280_46_M20 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_8280_46_M20'));
var F_16NW = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_16NW'));
var F_16SW = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_16SW'));
var Judys = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var East_Harvey = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var West_Harvey = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'West_Harvey'));
var Flat = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Flat'));
var Pops = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Seed_Rice = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Seed_Rice'));
var Shanes = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Haley = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var Morris = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Morris'));
var Carr_North = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Carr_North'));
var Carr_South = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Carr_South'));
var West_Joe_T = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'West_Joe_T'));
var East_Joe_T = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_Joe_T'));
var The_90 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var HQ_Shop = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Way_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var New_Ground = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'New_Ground'));
var Top_of_Res = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_03 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_03'));
var Kelly_04 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_06 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_09 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_09'));
var Kelly_10 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Bransford_Est = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_09 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_09'));
var East_10 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Walls_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_01'));
var Walls_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_02'));
var Walls_03 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_03'));
var Walls_04 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_04'));
var Walls_05 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_05'));
var Walls_06_07 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_06_07'));
var Walls_09 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_09'));
var Walls_10 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_10'));
var Walls_11 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_11'));
var Walls_12 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_12'));
var Walls_13 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Walls_13'));
var LIB2_Farm_01 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'LIB2_Farm_01'));
var HT1_Farm_1 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'HT1_Farm_1'));
var R10E_Farm_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'R10E_Farm_02'));
var R2_Farm_02 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'R2_Farm_02'));
var K140E_Farm_03 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'K140E_Farm_03'));
var K140W_Farm_03 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'K140W_Farm_03'));
var T18M_Farm_05 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'T18M_Farm_05'));
var F_4East_Farm_8 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'F_4East_Farm_8'));
var Field_2_Farm_8 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'Field_2_Farm_8'));
var North_0_Farm_09 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'North_0_Farm_09'));
var South_0_Farm_09 = PDHD2022.filter(ee.Filter.eq('FIELD_NAME', 'South_0_Farm_09'));
...
var results = {
  ...
  'F_8280_46_M20': reduceByFeatureCollection(processedPOI1, F_8280_46_M20),
  'F_16NW': reduceByFeatureCollection(processedPOI2, F_16NW),
  'F_16SW': reduceByFeatureCollection(processedPOI2, F_16SW),
  ...
  'East_Joe_T': reduceByFeatureCollection(processedPOI1, East_Joe_T),
  ...
  'Walls_06_07': reduceByFeatureCollection(processedPOI1, Walls_06_07),
  ...
  'LIB2_Farm_01': reduceByFeatureCollection(processedPOI5, LIB2_Farm_01),
  'HT1_Farm_1': reduceByFeatureCollection(processedPOI5, HT1_Farm_1),
  'R10E_Farm_02': reduceByFeatureCollection(processedPOI1, R10E_Farm_02),
  'R2_Farm_02': reduceByFeatureCollection(processedPOI1, R2_Farm_02),
  'K140E_Farm_03': reduceByFeatureCollection(processedPOI1, K140E_Farm_03),
  'K140W_Farm_03': reduceByFeatureCollection(processedPOI1, K140W_Farm_03),
  'T18M_Farm_05': reduceByFeatureCollection(processedPOI1, T18M_Farm_05),
  'F_4East_Farm_8': reduceByFeatureCollection(processedPOI1, F_4East_Farm_8),
  'Field_2_Farm_8': reduceByFeatureCollection(processedPOI1, Field_2_Farm_8),
  'North_0_Farm_09': reduceByFeatureCollection(processedPOI1, North_0_Farm_09),
...
var meteoResults = {
  ...
  'F_8280_46_M20': reduceByFeatureCollection(mergedCollection, F_8280_46_M20),
  'F_16NW': reduceByFeatureCollection(mergedCollection, F_16NW),
  'F_16SW': reduceByFeatureCollection(mergedCollection, F_16SW),
 ...
 // 'East_Harvey': reduceByFeatureCollection(mergedCollection, East_Harvey),
  ...
  'East_Joe_T': reduceByFeatureCollection(mergedCollection, East_Joe_T),
  ...
  'Walls_06_07': reduceByFeatureCollection(mergedCollection, Walls_06_07),
  ...
  'LIB2_Farm_01': reduceByFeatureCollection(mergedCollection, LIB2_Farm_01),
  'HT1_Farm_1': reduceByFeatureCollection(mergedCollection, HT1_Farm_1),
  'R10E_Farm_02': reduceByFeatureCollection(mergedCollection, R10E_Farm_02),
  'R2_Farm_02': reduceByFeatureCollection(mergedCollection, R2_Farm_02),
  'K140E_Farm_03': reduceByFeatureCollection(mergedCollection, K140E_Farm_03),
  'K140W_Farm_03': reduceByFeatureCollection(mergedCollection, K140W_Farm_03),
  'T18M_Farm_05': reduceByFeatureCollection(mergedCollection, T18M_Farm_05),
  'F_4East_Farm_8': reduceByFeatureCollection(mergedCollection, F_4East_Farm_8),
  'Field_2_Farm_8': reduceByFeatureCollection(mergedCollection, Field_2_Farm_8),
  'North_0_Farm_09': reduceByFeatureCollection(mergedCollection, North_0_Farm_09),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2022', // Updated filename
