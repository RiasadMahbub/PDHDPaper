var PDHD2020 = ee.FeatureCollection("projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2020"),
...
var fieldNames = PDHD2020.aggregate_array('FIELD_NAME');

// ######################################################################################################
//                              ### AUTOMATED VI EXPORT BY PATHROWTIL ###
// ######################################################################################################
/// Load the PDHD2020 FeatureCollection
var PDHD2020 = ee.FeatureCollection('projects/ee-my-riasadbmahbub/assets/DOPDOHDL/PDHD2020');
print("PDHD2020",PDHD2020)
var F_8262_13_Sm_1 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8262_13_Sm_1'));
var F_8261_9_M7 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8261_9_M7'));
var F_8263_14_Sm_2 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8263_14_Sm_2'));
var F_8248_10_M6 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8248_10_M6'));
var F_8259_3_M3 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8259_3_M3'));
var F_8254_4_M10 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8254_4_M10'));
var F_8250_12_M8 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8250_12_M8'));
var F_8245_23_Cr = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8245_23_Cr'));
var F_8267_34_AP_2 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8267_34_AP_2'));
var F_8287_42_M30 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8287_42_M30'));
var F_8266_33_AP_1 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8266_33_AP_1'));
var F_8278_38_M18 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8278_38_M18'));
var F_8293_32_Pn_House = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8293_32_Pn_House'));
var F_8289_22_MP = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8289_22_MP'));
var F_8290_27_Pn_1 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8290_27_Pn_1'));
var F_8292_29_Pn_3 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8292_29_Pn_3'));
var F_8291_28_Pn_2 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8291_28_Pn_2'));
var F_8313_59_7 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8313_59_7'));
var F_8309_55_3 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8309_55_3'));
var F_8307_53_1 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8307_53_1'));
var F_8308_54_2 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8308_54_2'));
var F_8320_66_6 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_8320_66_6'));
var F_20580_67_58_Acre = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_20580_67_58_Acre'));
var F_20582_69_Res_N = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_20582_69_Res_N'));
var F_4N = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_4N'));
var SeagravesSouth = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'SeagravesSouth'));
var SeagravesNorth = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'SeagravesNorth'));
var F_201 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_201'));
var F_202 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'F_202'));
var Judys = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Judys'));
var East_Harvey = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_Harvey'));
var Flat = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Flat'));
var Pops = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Pops'));
var Seed_Rice = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Seed_Rice'));
var Shanes = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Shanes'));
var Haley = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Haley'));
var Carr_North = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Carr_North'));
var Carr_South = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Carr_South'));
var West_Joe_T = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'West_Joe_T'));
var The_90 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'The_90'));
var HQ_Shop = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'HQ_Shop'));
var Lyntz = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Lyntz'));
var Cotton_Patch = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Cotton_Patch'));
var Way_01 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Way_01'));
var Way_02 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Way_02'));
var Way_03 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Way_03'));
var Way_04 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Way_04'));
var Way_05 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Way_05'));
var Baker_30 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Baker_30'));
var Top_of_Res = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Top_of_Res'));
var Bott_of_Res = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Bott_of_Res'));
var Baker_40 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Baker_40'));
var Baker_20 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Baker_20'));
var Baker_50 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Baker_50'));
var Kelly_01 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_01'));
var Kelly_02 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_02'));
var Kelly_04 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_04'));
var Kelly_05 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_05'));
var Kelly_06 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_06'));
var Kelly_07 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_07'));
var Kelly_08 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_08'));
var Kelly_10 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_10'));
var Kelly_11 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Kelly_11'));
var Bransford_Est = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Bransford_Est'));
var Mid_Bransford = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Mid_Bransford'));
var Wst_Bransford = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Wst_Bransford'));
var East_01 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_01'));
var East_02 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_02'));
var East_04 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_04'));
var East_05 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_05'));
var East_06 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_06'));
var East_07 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_07'));
var East_08 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_08'));
var East_09 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_09'));
var East_10 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_10'));
var East_11 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_11'));
var East_12 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_12'));
var East_13 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_13'));
var East_14 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'East_14'));
var Cattlet_01 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_01'));
var Cattlet_02 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Cattlet_02'));
var Walls_01 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_01'));
var Walls_02 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_02'));
var Walls_03 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_03'));
var Walls_04 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_04'));
var Walls_05 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_05'));
var Walls_09 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_09'));
var Walls_10 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_10'));
var Walls_11 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_11'));
var Walls_12 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_12'));
var Walls_13 = PDHD2020.filter(ee.Filter.eq('FIELD_NAME', 'Walls_13'));
...
var results = {
  'F_8262_13_Sm_1': reduceByFeatureCollection(processedPOI1, F_8262_13_Sm_1),
  ...
  'F_8267_34_AP_2': reduceByFeatureCollection(processedPOI1, F_8267_34_AP_2),
  ...
  'F_8293_32_Pn_House': reduceByFeatureCollection(processedPOI1, F_8293_32_Pn_House),
  'F_8289_22_MP': reduceByFeatureCollection(processedPOI1, F_8289_22_MP),
  ...
  'F_8313_59_7': reduceByFeatureCollection(processedPOI1, F_8313_59_7),
  ...
  'F_4N': reduceByFeatureCollection(processedPOI2, F_4N),
  'SeagravesSouth': reduceByFeatureCollection(processedPOI2, SeagravesSouth),
  'SeagravesNorth': reduceByFeatureCollection(processedPOI2, SeagravesNorth),
...
var meteoResults = {
  'F_8262_13_Sm_1': reduceByFeatureCollection(mergedCollection, F_8262_13_Sm_1),
  ...
  'F_8267_34_AP_2': reduceByFeatureCollection(mergedCollection, F_8267_34_AP_2),
  ...
  'F_8293_32_Pn_House': reduceByFeatureCollection(mergedCollection, F_8293_32_Pn_House),
  'F_8289_22_MP': reduceByFeatureCollection(mergedCollection, F_8289_22_MP),
  ...
  'F_8313_59_7': reduceByFeatureCollection(mergedCollection, F_8313_59_7),
  ...
  'F_4N': reduceByFeatureCollection(mergedCollection, F_4N),
  'SeagravesSouth': reduceByFeatureCollection(mergedCollection, SeagravesSouth),
  'SeagravesNorth': reduceByFeatureCollection(mergedCollection, SeagravesNorth),
...
Object.keys(meteoResults).forEach(function(site) {
  ...
  Export.table.toDrive({
    collection: cleanedCollection,
    description: site + '_Meteo2020', // Updated filename
